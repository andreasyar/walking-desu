...
public class VisibleManager implements Runnable {
    ...
    synchronized public void update() {
        System.out.println(Thread.currentThread().getId() + " Its UPDATE time.");

        Point beg, end, cur;
        try {
        synchronized (players) {
            System.out.println(Thread.currentThread().getId() + " We took players.");
            for (Player p1 : players) {
                ...
                synchronized (towers) {
                    System.out.println(Thread.currentThread().getId() + " We took towers.");
                    for (Tower t : towers) {
        ...
        System.out.println(Thread.currentThread().getId() + " We done.");
    }
